 ...
 */
export interface ListResponseOrgAddon {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseOrgAddon.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.OrgAddon[] | undefined;
...
export namespace ListResponseOrgAddon {
    /** Object type discriminator. Always `list` for this envelope. */
