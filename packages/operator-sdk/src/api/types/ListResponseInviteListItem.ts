 ...
 */
export interface ListResponseInviteListItem {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseInviteListItem.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.InviteListItem[] | undefined;
...
export namespace ListResponseInviteListItem {
    /** Object type discriminator. Always `list` for this envelope. */
