 ...
 */
export interface ListResponseArtifact {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseArtifact.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.Artifact[] | undefined;
...
export namespace ListResponseArtifact {
    /** Object type discriminator. Always `list` for this envelope. */
