 ...
 */
export interface ListResponseOrganizationDomain {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseOrganizationDomain.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.OrganizationDomain[] | undefined;
...
export namespace ListResponseOrganizationDomain {
    /** Object type discriminator. Always `list` for this envelope. */
