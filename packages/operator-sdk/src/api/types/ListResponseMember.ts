 ...
 */
export interface ListResponseMember {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseMember.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.Member[] | undefined;
...
export namespace ListResponseMember {
    /** Object type discriminator. Always `list` for this envelope. */
