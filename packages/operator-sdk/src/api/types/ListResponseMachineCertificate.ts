 ...
 */
export interface ListResponseMachineCertificate {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseMachineCertificate.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.MachineCertificate[] | undefined;
...
export namespace ListResponseMachineCertificate {
    /** Object type discriminator. Always `list` for this envelope. */
