 ...
 */
export interface ListResponseWebhookDeadLetter {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseWebhookDeadLetter.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.WebhookDeadLetter[] | undefined;
...
export namespace ListResponseWebhookDeadLetter {
    /** Object type discriminator. Always `list` for this envelope. */
