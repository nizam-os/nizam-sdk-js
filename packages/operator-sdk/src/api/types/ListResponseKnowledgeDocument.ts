 ...
 */
export interface ListResponseKnowledgeDocument {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseKnowledgeDocument.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.KnowledgeDocument[] | undefined;
...
export namespace ListResponseKnowledgeDocument {
    /** Object type discriminator. Always `list` for this envelope. */
