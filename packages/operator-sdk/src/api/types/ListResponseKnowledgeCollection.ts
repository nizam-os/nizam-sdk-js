 ...
 */
export interface ListResponseKnowledgeCollection {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseKnowledgeCollection.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.KnowledgeCollection[] | undefined;
...
export namespace ListResponseKnowledgeCollection {
    /** Object type discriminator. Always `list` for this envelope. */
