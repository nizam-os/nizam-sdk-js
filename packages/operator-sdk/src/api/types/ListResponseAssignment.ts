 ...
 */
export interface ListResponseAssignment {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseAssignment.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.Assignment[] | undefined;
...
export namespace ListResponseAssignment {
    /** Object type discriminator. Always `list` for this envelope. */
