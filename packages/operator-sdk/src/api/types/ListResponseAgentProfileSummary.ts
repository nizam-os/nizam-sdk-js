 ...
 */
export interface ListResponseAgentProfileSummary {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseAgentProfileSummary.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.AgentProfileSummary[] | undefined;
...
export namespace ListResponseAgentProfileSummary {
    /** Object type discriminator. Always `list` for this envelope. */
