 ...
 */
export interface ListResponseAddonSummary {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseAddonSummary.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.AddonSummary[] | undefined;
...
export namespace ListResponseAddonSummary {
    /** Object type discriminator. Always `list` for this envelope. */
