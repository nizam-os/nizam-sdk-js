 ...
 */
export interface ListResponseOperator {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseOperator.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamOperatorRuntime.Operator[] | undefined;
...
export namespace ListResponseOperator {
    /** Object type discriminator. Always `list` for this envelope. */
