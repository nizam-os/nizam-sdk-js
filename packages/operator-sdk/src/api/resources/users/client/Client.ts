...
export class UsersClient {
     ...
     *
     * @param {NizamOperatorRuntime.UpdateMeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamOperatorRuntime.UnauthorizedError}
     * @throws {@link NizamOperatorRuntime.ForbiddenError}
     ...
     */
    public updateMe(
        request: NizamOperatorRuntime.UpdateMeRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamOperatorRuntime.User> {
    ...
    public meCredentials(
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamOperatorRuntime.UserCredentials> {
        return core.HttpResponsePromise.fromPromise(this.__meCredentials(requestOptions));
    }

    private async __meCredentials(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamOperatorRuntime.UserCredentials>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamOperatorRuntime.UserCredentials, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamOperatorRuntime.ConfirmPhoneChangeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamOperatorRuntime.UnauthorizedError}
     * @throws {@link NizamOperatorRuntime.ForbiddenError}
    ...
    public confirmPhoneChange(
        request: NizamOperatorRuntime.ConfirmPhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamOperatorRuntime.PhoneChangedResponse> {
    ...
    private async __confirmPhoneChange(
        request: NizamOperatorRuntime.ConfirmPhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamOperatorRuntime.PhoneChangedResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamOperatorRuntime.PhoneChangedResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {NizamOperatorRuntime.PhoneChangeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamOperatorRuntime.UnauthorizedError}
     * @throws {@link NizamOperatorRuntime.ForbiddenError}
    ...
    public startPhoneChange(
        request: NizamOperatorRuntime.PhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamOperatorRuntime.StartPhoneChangeResponse> {
    ...
    private async __startPhoneChange(
        request: NizamOperatorRuntime.PhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamOperatorRuntime.StartPhoneChangeResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamOperatorRuntime.StartPhoneChangeResponse,
                rawResponse: _response.rawResponse,
            };
        }
