...
export class RealtimeClient {
    ...
    ): core.HttpResponsePromise<NizamOperatorRuntime.RealtimeTicket> {
    ...
    private async __createRealtimeTicket(
        requestOptions?: RealtimeClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamOperatorRuntime.RealtimeTicket>> {
        ...
        if (_response.ok) {
            return { data: _response.body as NizamOperatorRuntime.RealtimeTicket, rawResponse: _response.rawResponse };
        }
