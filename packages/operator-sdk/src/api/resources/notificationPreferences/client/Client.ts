...
export class NotificationPreferencesClient {
    ...
    ): core.HttpResponsePromise<NizamOperatorRuntime.NotificationPreferences> {
    ...
    private async __getNotificationPreferences(
        requestOptions?: NotificationPreferencesClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamOperatorRuntime.NotificationPreferences>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamOperatorRuntime.NotificationPreferences,
    ...
    public updateNotificationPreferences(
        request: NizamOperatorRuntime.UpdateNotificationPreferences = {},
        requestOptions?: NotificationPreferencesClient.RequestOptions,
    ): core.HttpResponsePromise<NizamOperatorRuntime.NotificationPreferences> {
