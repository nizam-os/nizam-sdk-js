...
export interface ListFilesRequest {
    ...
    kind?: NizamCustomer.ListFilesRequestKindItem | NizamCustomer.ListFilesRequestKindItem[];
    /** Filter by lifecycle status. Comma-separated; matched case-insensitively. */
    status?: NizamCustomer.ListFilesRequestStatusItem | NizamCustomer.ListFilesRequestStatusItem[];
    ...
    sort?: NizamCustomer.ListFilesRequestSortItem | NizamCustomer.ListFilesRequestSortItem[];
