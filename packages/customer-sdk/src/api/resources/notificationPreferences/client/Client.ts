...
export class NotificationPreferencesClient {
    ...
    ): core.HttpResponsePromise<NizamCustomer.NotificationPreferences> {
    ...
    private async __getNotificationPreferences(
        requestOptions?: NotificationPreferencesClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.NotificationPreferences>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamCustomer.NotificationPreferences,
    ...
    public updateNotificationPreferences(
        request: NizamCustomer.UpdateNotificationPreferences = {},
        requestOptions?: NotificationPreferencesClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCustomer.NotificationPreferences> {
