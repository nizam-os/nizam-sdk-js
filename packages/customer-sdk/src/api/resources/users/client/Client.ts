...
export class UsersClient {
     ...
     *
     * @param {NizamCustomer.UpdateMeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamCustomer.UnauthorizedError}
     * @throws {@link NizamCustomer.ForbiddenError}
     ...
     */
    public updateMe(
        request: NizamCustomer.UpdateMeRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCustomer.User> {
    ...
    private async __updateMe(
        request: NizamCustomer.UpdateMeRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.User>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
    ...
    public meCredentials(
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCustomer.UserCredentials> {
        return core.HttpResponsePromise.fromPromise(this.__meCredentials(requestOptions));
    }

    private async __meCredentials(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.UserCredentials>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamCustomer.UserCredentials, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamCustomer.ConfirmPhoneChangeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamCustomer.UnauthorizedError}
     * @throws {@link NizamCustomer.ForbiddenError}
    ...
    public confirmPhoneChange(
        request: NizamCustomer.ConfirmPhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCustomer.PhoneChangedResponse> {
    ...
    private async __confirmPhoneChange(
        request: NizamCustomer.ConfirmPhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.PhoneChangedResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamCustomer.PhoneChangedResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamCustomer.PhoneChangeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamCustomer.UnauthorizedError}
     * @throws {@link NizamCustomer.ForbiddenError}
    ...
    public startPhoneChange(
        request: NizamCustomer.PhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCustomer.StartPhoneChangeResponse> {
    ...
    private async __startPhoneChange(
        request: NizamCustomer.PhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.StartPhoneChangeResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamCustomer.StartPhoneChangeResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public initiateProfilePictureUpload(
        request: NizamCustomer.InitiateProfilePictureUploadRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCustomer.UploadInitiation> {
    ...
    private async __initiateProfilePictureUpload(
        request: NizamCustomer.InitiateProfilePictureUploadRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.UploadInitiation>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamCustomer.UploadInitiation, rawResponse: _response.rawResponse };
        }
    ...
    public getUserProfilePicture(
        request: NizamCustomer.GetUserProfilePictureRequest,
        requestOptions?: UsersClient.RequestOptions,
