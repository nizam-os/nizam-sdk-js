...
export class RealtimeClient {
    ...
    ): core.HttpResponsePromise<NizamCustomer.RealtimeTicket> {
    ...
    private async __createRealtimeTicket(
        requestOptions?: RealtimeClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.RealtimeTicket>> {
        ...
        if (_response.ok) {
            return { data: _response.body as NizamCustomer.RealtimeTicket, rawResponse: _response.rawResponse };
        }
