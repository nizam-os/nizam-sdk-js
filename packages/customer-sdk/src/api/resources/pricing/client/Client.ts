...
export class PricingClient {
    ...
    ): core.HttpResponsePromise<NizamCustomer.ListResponsePricingPlan> {
        return core.HttpResponsePromise.fromPromise(this.__listPricing(requestOptions));
    }

    private async __listPricing(
        requestOptions?: PricingClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCustomer.ListResponsePricingPlan>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamCustomer.ListResponsePricingPlan,
