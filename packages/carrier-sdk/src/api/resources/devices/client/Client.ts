...
export class DevicesClient {
     ...
     */
    public listDevices(requestOptions?: DevicesClient.RequestOptions): core.HttpResponsePromise<NizamCarrier.Devices> {
    ...
    private async __listDevices(
    ...
    ): Promise<core.WithRawResponse<NizamCarrier.Devices>> {
        ...
        if (_response.ok) {
            return { data: _response.body as NizamCarrier.Devices, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamCarrier.RegisterDevice} request
     * @param {DevicesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamCarrier.UnauthorizedError}
     * @throws {@link NizamCarrier.ForbiddenError}
    ...
    public registerDevice(
        request: NizamCarrier.RegisterDevice,
        requestOptions?: DevicesClient.RequestOptions,
    ): core.HttpResponsePromise<NizamCarrier.Device> {
    ...
    private async __registerDevice(
        request: NizamCarrier.RegisterDevice,
        requestOptions?: DevicesClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamCarrier.Device>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamCarrier.Device, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamCarrier.DeregisterDeviceRequest} request
     * @param {DevicesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamCarrier.UnauthorizedError}
     * @throws {@link NizamCarrier.ForbiddenError}
    ...
    public deregisterDevice(
        request: NizamCarrier.DeregisterDeviceRequest,
        requestOptions?: DevicesClient.RequestOptions,
