...
export class PricingClient {
    ...
    ): core.HttpResponsePromise<NizamMerchant.ListResponsePricingPlan> {
        return core.HttpResponsePromise.fromPromise(this.__listPricing(requestOptions));
    }

    private async __listPricing(
        requestOptions?: PricingClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponsePricingPlan>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamMerchant.ListResponsePricingPlan,
