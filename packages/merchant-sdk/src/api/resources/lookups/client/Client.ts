...
export class LookupsClient {
    ...
    ): core.HttpResponsePromise<NizamMerchant.ListResponseBusinessCategory> {
    ...
    private async __listBusinessCategories(
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponseBusinessCategory>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamMerchant.ListResponseBusinessCategory,
    ...
    public listCountries(
        requestOptions?: LookupsClient.RequestOptions,
    ): core.HttpResponsePromise<NizamMerchant.ListResponseCountry> {
        return core.HttpResponsePromise.fromPromise(this.__listCountries(requestOptions));
    }

    private async __listCountries(
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponseCountry>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamMerchant.ListResponseCountry, rawResponse: _response.rawResponse };
        }
    ...
    public listCurrencies(
        requestOptions?: LookupsClient.RequestOptions,
    ): core.HttpResponsePromise<NizamMerchant.ListResponseCurrency> {
        return core.HttpResponsePromise.fromPromise(this.__listCurrencies(requestOptions));
    }

    private async __listCurrencies(
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponseCurrency>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamMerchant.ListResponseCurrency, rawResponse: _response.rawResponse };
        }
    ...
    public listLanguages(
        requestOptions?: LookupsClient.RequestOptions,
    ): core.HttpResponsePromise<NizamMerchant.ListResponseLanguage> {
        return core.HttpResponsePromise.fromPromise(this.__listLanguages(requestOptions));
    }

    private async __listLanguages(
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponseLanguage>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamMerchant.ListResponseLanguage, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamMerchant.LookupSsoRouteRequest} request
     * @param {LookupsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamMerchant.UnauthorizedError}
     * @throws {@link NizamMerchant.TooManyRequestsError}
    ...
    public lookupSsoRoute(
        request: NizamMerchant.LookupSsoRouteRequest,
        requestOptions?: LookupsClient.RequestOptions,
    ): core.HttpResponsePromise<NizamMerchant.SsoRoute> {
    ...
    private async __lookupSsoRoute(
        request: NizamMerchant.LookupSsoRouteRequest,
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.SsoRoute>> {
        ...
        if (_response.ok) {
            return { data: _response.body as NizamMerchant.SsoRoute, rawResponse: _response.rawResponse };
        }
    ...
    public listTimezones(
        requestOptions?: LookupsClient.RequestOptions,
    ): core.HttpResponsePromise<NizamMerchant.ListResponseTimezone> {
        return core.HttpResponsePromise.fromPromise(this.__listTimezones(requestOptions));
    }

    private async __listTimezones(
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponseTimezone>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamMerchant.ListResponseTimezone, rawResponse: _response.rawResponse };
        }
