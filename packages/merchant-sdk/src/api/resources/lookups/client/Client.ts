...
export class LookupsClient {
    ...
    ): core.HttpResponsePromise<NizamMerchant.ListResponse> {
    ...
    private async __listBusinessCategories(
        requestOptions?: LookupsClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamMerchant.ListResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as NizamMerchant.ListResponse, rawResponse: _response.rawResponse };
        }
