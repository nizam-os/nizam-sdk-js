...
export class PricingClient {
    ...
    ): core.HttpResponsePromise<NizamDashboard.ListResponsePricingPlan> {
        return core.HttpResponsePromise.fromPromise(this.__listPricing(requestOptions));
    }

    private async __listPricing(
        requestOptions?: PricingClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.ListResponsePricingPlan>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamDashboard.ListResponsePricingPlan,
