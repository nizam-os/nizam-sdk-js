 ...
 *     }
 */
export interface ListOrgAddonsRequest {
    /** Filter by lifecycle status. Comma-separated; matched case-insensitively. */
    status?: NizamDashboard.ListOrgAddonsRequestStatusItem | NizamDashboard.ListOrgAddonsRequestStatusItem[];
    ...
    sort?: NizamDashboard.ListOrgAddonsRequestSortItem | NizamDashboard.ListOrgAddonsRequestSortItem[];
