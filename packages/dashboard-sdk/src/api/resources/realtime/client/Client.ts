...
export class RealtimeClient {
    ...
    ): core.HttpResponsePromise<NizamDashboard.RealtimeTicket> {
    ...
    private async __createRealtimeTicket(
        requestOptions?: RealtimeClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.RealtimeTicket>> {
        ...
        if (_response.ok) {
            return { data: _response.body as NizamDashboard.RealtimeTicket, rawResponse: _response.rawResponse };
        }
