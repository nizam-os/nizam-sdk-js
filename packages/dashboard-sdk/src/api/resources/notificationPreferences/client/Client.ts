...
export class NotificationPreferencesClient {
    ...
    ): core.HttpResponsePromise<NizamDashboard.NotificationPreferences> {
    ...
    private async __getNotificationPreferences(
        requestOptions?: NotificationPreferencesClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.NotificationPreferences>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamDashboard.NotificationPreferences,
    ...
    public updateNotificationPreferences(
        request: NizamDashboard.UpdateNotificationPreferences = {},
        requestOptions?: NotificationPreferencesClient.RequestOptions,
    ): core.HttpResponsePromise<NizamDashboard.NotificationPreferences> {
