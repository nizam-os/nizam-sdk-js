...
export class UsersClient {
     ...
     *
     * @param {NizamDashboard.UpdateMeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamDashboard.UnauthorizedError}
     * @throws {@link NizamDashboard.ForbiddenError}
     ...
     */
    public updateMe(
        request: NizamDashboard.UpdateMeRequest = {},
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamDashboard.User> {
    ...
    public meCredentials(
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamDashboard.UserCredentials> {
        return core.HttpResponsePromise.fromPromise(this.__meCredentials(requestOptions));
    }

    private async __meCredentials(
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.UserCredentials>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamDashboard.UserCredentials, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamDashboard.ConfirmPhoneChangeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamDashboard.UnauthorizedError}
     * @throws {@link NizamDashboard.ForbiddenError}
    ...
    public confirmPhoneChange(
        request: NizamDashboard.ConfirmPhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamDashboard.PhoneChangedResponse> {
    ...
    private async __confirmPhoneChange(
        request: NizamDashboard.ConfirmPhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.PhoneChangedResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamDashboard.PhoneChangedResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {NizamDashboard.PhoneChangeRequest} request
     * @param {UsersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link NizamDashboard.UnauthorizedError}
     * @throws {@link NizamDashboard.ForbiddenError}
    ...
    public startPhoneChange(
        request: NizamDashboard.PhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): core.HttpResponsePromise<NizamDashboard.StartPhoneChangeResponse> {
    ...
    private async __startPhoneChange(
        request: NizamDashboard.PhoneChangeRequest,
        requestOptions?: UsersClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.StartPhoneChangeResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as NizamDashboard.StartPhoneChangeResponse,
                rawResponse: _response.rawResponse,
            };
        }
