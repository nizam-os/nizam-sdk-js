...
export class DevicesClient {
    ...
    private async __listDevices(
        ...
        if (_response.ok) {
            return { data: _response.body as NizamDashboard.Devices, rawResponse: _response.rawResponse };
        }
    ...
    public registerDevice(
        request: NizamDashboard.RegisterDevice,
        requestOptions?: DevicesClient.RequestOptions,
    ): core.HttpResponsePromise<NizamDashboard.Device> {
    ...
    private async __registerDevice(
        request: NizamDashboard.RegisterDevice,
        requestOptions?: DevicesClient.RequestOptions,
    ): Promise<core.WithRawResponse<NizamDashboard.Device>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as NizamDashboard.Device, rawResponse: _response.rawResponse };
        }
    ...
    public deregisterDevice(
        request: NizamDashboard.DeregisterDeviceRequest,
        requestOptions?: DevicesClient.RequestOptions,
