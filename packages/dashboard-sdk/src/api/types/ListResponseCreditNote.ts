 ...
 */
export interface ListResponseCreditNote {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseCreditNote.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamDashboard.CreditNote[] | undefined;
...
export namespace ListResponseCreditNote {
    /** Object type discriminator. Always `list` for this envelope. */
