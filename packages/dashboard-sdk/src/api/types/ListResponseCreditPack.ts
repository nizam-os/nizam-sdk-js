 ...
 */
export interface ListResponseCreditPack {
    /** Object type discriminator. Always `list` for this envelope. */
    object?: ListResponseCreditPack.Object_ | undefined;
    /** Page of resources. Empty array when there are no matches. */
    data?: NizamDashboard.CreditPack[] | undefined;
...
export namespace ListResponseCreditPack {
    /** Object type discriminator. Always `list` for this envelope. */
